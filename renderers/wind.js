...
const size = {
    width: plan.offsetWidth,
    height: plan.offsetHeight
}
...
function init() {
    ...
    camera = new THREE.PerspectiveCamera(30, size.width / size.height, 1, 10000);
    ...
    const clothTexture = loader.load('../three/examples/textures/patterns/circuit_pattern.png');
    ...
    const groundTexture = loader.load('../three/examples/textures/terrain/grasslight-big.jpg');
